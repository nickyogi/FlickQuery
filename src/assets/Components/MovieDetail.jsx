...
function MovieDetail() {
  ...
  useEffect(() => {
    ...
    if(isFavourite) {setAlreadyFavourite(true);}
        ...
        <div className="w-full text-white px-2 sm:px-10 mt-5 sm:flex justify-end gap-10">
          ...
          <div className="w-[92vw]">
            <h1 className="text-[8vw] sm:text-[3.5vw] mt-[5vw] sm:mt-0 text-center sm:text-start font-bold sm:flex items-end tracking-wide leading-none">
              ...
              <h2 className="text-center mb-[5vw] sm:hidden inline"><small className=" text-[4vw] block text-zinc-200 mx-2 mb-[5px] tracking-normal">{`(${
                info.detail.release_date.split("-")[0]
              })`}</small></h2>
            ...
            <div className="hidden sm:flex items-center justify-between w-[80%]">
              ...
              <span className="font-semibold  leading-none ">{`Release : ${info.detail.release_date}`}</span>
              <span className="font-semibold  leading-none ">{`Duration : ${Math.floor(
            ...
            <div className="sm:hidden flex mb-10 items-center justify-between w-full">
              ...
              <div className="font-semibold flex-col items-center gap-10 leading-none ">
                <div className="h-[10vw] flex items-center ">
                  <h3 className="mt-6" >{info.detail.release_date}</h3>
                </div>
                <div className="text-center font-semibold text-sm leading-none pt-6" >Release</div>
              </div>
              <div className="font-semibold flex-col items-center  leading-none ">
              <div className="h-[10vw] flex items-center ">
              <h3 className="mt-6" >{`${Math.floor(
                info.detail.runtime / 60
              )}h ${info.detail.runtime % 60}min`}</h3>
              </div>
                <div className="text-center font-semibold text-sm leading-none pt-6" >Duration</div>
              </div>
            </div>

            <p className="text-base text-center sm:text-start leading-sm my-5 mb-10 sm:mb-0 sm:my-2 italic font-semibold">
              {info.detail.tagline}
            </p>
